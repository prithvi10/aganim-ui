...
import {
  buildProfileIndexMeta,
  buildProfileIndexSchemas,
} from "../utils/profileSeo";

export const meta: MetaFunction = () => buildProfileIndexMeta();
...
export default function ProfileIndexPage() {
  ...
  return (
    <ProfilePageShell>
      <ProfileJsonLd schemas={buildProfileIndexSchemas(profileData)} />
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {filteredProjects.map((project) => (
            <Reveal key={project.slug}>
              <Link
                to={`/profile/projects/${project.slug}`}
