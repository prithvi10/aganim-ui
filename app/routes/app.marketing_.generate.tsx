...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  ...
  const templateId = url.searchParams.get('template') || 'marketing/email-launch';
  ...
  return { shop, backendApiUrl, template, templateId };
};
...
export default function MarketingContentGenerator() {
  ...
  if (!template) {
    return (
      <Page title="Marketing Content Generator">
        <Layout>
          <Layout.Section>
              ...
              <Form onSubmit={handleSubmit}>
                <BlockStack gap="400">
                  ...
                  <InlineStack gap="200">
                    ...
                    <Button onClick={() => navigate(nav('/app/marketing'))}>
                      Cancel
                    </Button>
                  </InlineStack>
                </BlockStack>
